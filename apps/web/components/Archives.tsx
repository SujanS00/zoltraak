...
export function Archives() {
  ...
  return (
    <div className="flex h-[500px] w-full bg-card/40 border border-border/40 rounded-3xl overflow-hidden shadow-2xl backdrop-blur-md">
      {/* SIDEBAR: Folder/Note List */}
      <div className="w-64 border-r border-border/20 bg-muted/10 p-4 flex flex-col gap-4">
        <button 
      ...
      {/* EDITOR: Content Area */}
      <div className="flex-1 p-8 flex flex-col bg-background/20">
        {activeNote ? (
